    ...
    <Table class= "table table-hover table-dark"> 
        ...
        @foreach($show as $showdata)
            ...
            <tr>
              ...
              <td> {{$showdata->age}}</td>
              <td> {{$showdata->homeTown}}</td>
              <td> {{$showdata->contactNumber}}</td>
              <td> {{$showdata->registerDate}}</td>
              <td> {{$showdata->height}}</td>
              <td> {{$showdata->weight}}</td>
              <td> <a href="/updatepool/{{$showdata->id}}" class="btn btn-danger"> Update </a>  </td>
              <td> <a href="/pooldelete/{{$showdata->id}}" class="btn btn-success"> Delete </a> </td>
            </tr>
        @endforeach
