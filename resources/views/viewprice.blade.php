...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container">
        <h1 class="text-info text-center ">View Price</h1>
         <div class="row">
          <div class="col-sm-4" ><!--Food & Bevarages Price List-->
              ...
              <div class="card-header  text-white" style="height: 150px;background: linear-gradient(to right, rgb(242, 112, 156), rgb(255, 148, 114));" >
                <div class="row">
                  ...
                  <div class="col-lg-8" style="text-align:right">
                      <h4>Food & Bevarages Price List</h4>
                  </div>
          ...
          </div><!--End of Food & Bevarages Price List-->

          <div class="col-sm-4" ><!--Banqeut Hall Price List-->
            <div class="card border" >
              <div class="card-header  text-white" style="height: 150px;background: linear-gradient(to right, rgb(242, 112, 156), rgb(255, 148, 114));" >
                <div class="row">
                  <div class="col-lg-4" style="text-align: left">
          ...
          </div><!--End of Banqeut Hall Price List-->

          <div class="col-sm-4" ><!--Pool Price List-->
            <div class="card border" >
              <div class="card-header  text-white" style="height: 150px;background: linear-gradient(to right, rgb(242, 112, 156), rgb(255, 148, 114));" >
                <div class="row">
                  <div class="col-lg-4" style="text-align: left">
          ...
          </div><!--End of Pool Price List-->
         </div>
         <button type="submit" class="btn btn-danger mt-4  "> Exit</button>
