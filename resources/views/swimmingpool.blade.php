...
<head>
  ...
  <link href="css/spool.css" rel="stylesheet">
...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper">
    ...
    <div style="background-image: url(../images/pool2.jpg); height: 1000px; width: 1500px; border: 1px solid black; background-repeat: no-repeat; align:center">
	<div class="center">
			<h2><b>WELCOME TO THE POOL</b></h2>
	...
	<div class="pool">	
    <div class="a">
		<b>	The type of this endless swimming pool can install it directly into the soil which no need to reserved the equipment pit in advance.
			 And there with two repair ports are designed at the top of the counter current machine which is easy for maintenance.
			 At the same time, this installation method can save more cost of construction and decoration for the user.
			 Also the endless swimming pool with its own steps which is easy to rise and fall the pool.
			 And the counter current machine(double pump) with strong power that suitable for professional swimming training. 
			 Especially for triathlon athletes, DGL7900 Endles Pool is an excellent triathlon swimming training machine. 
			 It can not only simulate the water flow in open water, but also adjust the speed of the 12 gears. 
			 Due to the use of dual pumps, ordinary endless pools cannot achieve the power as it generates, which is exactly what triathletes need most. 
       If you already have a swimming pool, you can consider using this HSM6800 Swimming Training Machine, it is very easy to install. </b>
	...
	<table class="table"> 
		<tr>
			<td><a href="/poolreg" class="btn btn-primary">One Month Package</a></td>
			<td><a href="/poolreg" class="btn btn-primary">Three Month Package</a></td>
			<td><a href="/poolreg" class="btn btn-primary">Six Month Package</a></td>
			<td><a href="/poolreg" class="btn btn-primary"> One Year Package </a></td>
		</tr>
	</table>
	</div> 
  </div>
