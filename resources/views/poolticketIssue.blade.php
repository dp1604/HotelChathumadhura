...
<head>
  ...
  <link href="css/poolticketIssue.css" rel="stylesheet">
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  <div class="container">
  <div><h1 class="text-info text-center">POOL TICKET ISSUEANCE</h1></div>
    <div class="reg-box">
    <div class="row">
          <div  class="col-md-12"><br><br>
            <table class="center table table-dark">
                ...
                <tr>
                    <td>MID:</td>
                    <td><input type="text" class="mid" style="color:black;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Name:</td>
                    <td><input type="text" class="name" style="color:black;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Phone:</td>
                    <td><input type="num" class="phone" style="color:black;"></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Payment:</td>
                    <td><input type="radio" class="geny" value="Yes" >  Done</input>  <input type="radio" class="genn" value="No">  Pending</input></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>Ticket Status:</td>
                    <td><input type="radio" class="geny" value="Yes" > Yes</input>  <input type="radio" class="genn" value="No"> No</input></td>
                    <td><button type="submit" class="btn btn-primary" name="button">Submit</button></td>
                    <td></td>
