            ...
            <div class="container">
                ...
                <div class='col-sm-5 col-md-5 col-xs-12'>
                    <div>
                        ...
                        <div class='tab-content' id='check_availability'>
                            <div>
                                <form>
                                    <div class='row'>
                                        <div class='col-xxs-12 col-xs-12 mt'>
                                            <div class='input-field'>
                                                ...
                                                <input class='form-control' id='to-place' name='[arrivals]' type='number' value='1'>
                                            </div>
                                        </div>
                                        <div class='col-xxs-12 col-xs-12 mt'>
                                            <div class='input-field'>
                                                <label for='from'>Nights:</label>
                                                <input class='form-control' id='to-place' name='[nights]' type='number' value='1'>
                                            </div>
                                        </div>
                                        <div class='col-xxs-12 col-xs-6 mt alternate'>
                                            <div class='input-field'>
                                                <label for='date-end'>Adults:</label>
                                                <input class='form-control' name='[adult_count]' type='number' value='2'>
                                            </div>
                                        </div>
                                        <div class='col-xxs-12 col-xs-6 mt'>
                                            <section>
                                                <label for='class'>Children:</label>
                                                <input class='form-control' name='[children_count]' type='number' value='0'>
                                            </section>
                                        </div>
                                              <div class='col-xxs-12 col-xs-6 mt'>
                                                <input class='btn btn-primary btn-block' name='commit' type='submit' value='Check Availability !'>
                                              </div>
                                        </div>
                                    </form>
                            </div>
