...
<div class="container">
	...
	<div class="col-md-12 reg">
        <div class="text-center"><h1>WELCOME TO OUR POOL</h1></div>
        ...
        <form action="/savemem" method="post">
          @csrf
        ...
        <table class="table table-dark">
            ...
            <tr>
              <td>Member ID:<td>
              <td><input type="text" class="mid" name="MID" style="color:black;"></td>
              <td></td>
              <td></td>
            </tr>
            ...
            <tr>
              <td>First Name:<td>
              <td><input type="text" class="fname" name="firstName" style="color:black;"></td>
              <td></td>
              <td></td>
            </tr>
            ...
            <tr>
              <td>Last Name:<td>
              <td><input type="text" class="lname" name="lastName" style="color:black;"></td>
              <td></td>
              <td></td>
            </tr>
            ...
            <tr>
              <td>Gender:<td>
              <td><input type="radio" class="geny" value="Male" name="gender">Male</input>  <input type="radio" class="genn" value="Female" name="gender">Female</input> </td>
              <td>Height:</td>
              <td><input type="number" class="numa" name="height" style="color:black;">cm</td>
            </tr>

            <tr>
              <td>Age:<td>
              <td><input type="text" class="age" name="age" style="color:black;"></td>
              <td>Weight:</td>
              <td><input type="number" class="numb" name="weight" style="color:black;">Kg</td>
            </tr>

            <tr>
              <td>Home Town:<td>
              <td><input type="text" class="homet" name="homeTown" style="color:black;"></td>
              <td></td>
              <td></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="number" class="phone" name="contactNumber" style="color:black;"></td>
              <td><input type="submit" class="btn btn-primary" value="Save" style="color:black;"></td>
              <td></td>
            </tr>

            <tr>
              <td>Register Date:<td>
              <td><input type="date" class="date" name="registerDate" style="color:black;"></td>
              <td></td>
              <td></td>
            </tr>
